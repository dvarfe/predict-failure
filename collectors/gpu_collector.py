...
class AbstractGPUDataCollector(AbstractDataCollector):
    ...
    def get_feature_metadata(cls) -> Dict[str, FeatureMetadata]:
        ...
        return {
            ...
            "vendor": FeatureMetadata("vendor", FeatureType.CATEGORICAL, "", "Производитель GPU"),
            "type": FeatureMetadata("type", FeatureType.CATEGORICAL, "", "Тип GPU (discrete/integrated)"),
            "gpu_count": FeatureMetadata("gpu_count", FeatureType.NUMERICAL, "count", "Количество GPU"),
            "gpu_usage_percent": FeatureMetadata("gpu_usage_percent", FeatureType.NUMERICAL, "%", "Загрузка GPU"),
            "memory_used_mb": FeatureMetadata("memory_used_mb", FeatureType.NUMERICAL, "MB", "Использованная память"),
            "memory_total_mb": FeatureMetadata("memory_total_mb", FeatureType.NUMERICAL, "MB", "Общая память"),
            "memory_utilization_percent": FeatureMetadata("memory_utilization_percent", FeatureType.NUMERICAL, "%", "Использование памяти"),
            "temperature_c": FeatureMetadata("temperature_c", FeatureType.NUMERICAL, "°C", "Температура GPU"),
            "memory_temperature": FeatureMetadata("memory_temperature", FeatureType.NUMERICAL, "°C", "Температура памяти GPU"),
            "power_draw_w": FeatureMetadata("power_draw_w", FeatureType.NUMERICAL, "W", "Энергопотребление"),
            "power_limit": FeatureMetadata("power_limit", FeatureType.NUMERICAL, "W", "Лимит мощности GPU"),
            "max_power": FeatureMetadata("max_power", FeatureType.NUMERICAL, "W", "Максимальная мощность GPU"),
            "fan_speed_percent": FeatureMetadata("fan_speed_percent", FeatureType.NUMERICAL, "%", "Скорость вентилятора"),
            "core_clock_mhz": FeatureMetadata("core_clock_mhz", FeatureType.NUMERICAL, "MHz", "Частота ядра"),
            "memory_clock_mhz": FeatureMetadata("memory_clock_mhz", FeatureType.NUMERICAL, "MHz", "Частота памяти"),
            "gpu_name": FeatureMetadata("gpu_name", FeatureType.CATEGORICAL, "", "Название GPU"),
            "driver_version": FeatureMetadata("driver_version", FeatureType.CATEGORICAL, "", "Версия драйвера"),
            "processes": FeatureMetadata("processes", FeatureType.CATEGORICAL, "list", "Процессы использующие GPU"),
            "utilization_encoder": FeatureMetadata("utilization_encoder", FeatureType.NUMERICAL, "%", "Использование энкодера"),
            "utilization_decoder": FeatureMetadata("utilization_decoder", FeatureType.NUMERICAL, "%", "Использование декодера"),
        }
